...
DERBY_OPTS="${DERBY_OPTS} -XX:+UseSerialGC"
DERBY_OPTS="${DERBY_OPTS} -XX:MaxRAM=512m"
DERBY_OPTS="${DERBY_OPTS} -XX:+UseCGroupMemoryLimitForHeap"
DERBY_OPTS="${DERBY_OPTS} -XX:AdaptiveSizePolicyWeight=90"
